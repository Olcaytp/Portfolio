    ...
    <Card className="quote-card-view">
      <Card.Body>
        ...
        <ul>
          ...
          <br />
          <li className="about-activity"><ImPointRight /> I have completed the Lexicon System Developer Python & IT-Security program  to enhance my knowledge!</li><br />
          <li className="about-activity"><ImPointRight /> I  worked at the Acumant as a Software Developer with React. </li><br />
